...
export const dramas = sqliteTable('dramas', {
  ...
  virtualAssetGroupId: text('virtual_asset_group_id'),
...
export const characters = sqliteTable('characters', {
  ...
  virtualAssetId: text('virtual_asset_id'),
  virtualAssetUri: text('virtual_asset_uri'),
  virtualAssetSourceUrl: text('virtual_asset_source_url'),
  virtualAssetStatus: text('virtual_asset_status'),
